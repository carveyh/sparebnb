	...
	return (
		<div className="carousel-container">
			<div className="carousel-main">
				...
				<div className="category-selector" onClick={e => setFilter("beachfronts")}>
					<i className="fa-solid fa-umbrella-beach"></i>
					<span>Beachfront</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("treehouses")}>
					<i className="fa-solid fa-tower-observation"></i>
					<span>Treehouses</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("adapted")}>
					<i className="fa-brands fa-accessible-icon"></i>
					<span>Adapted</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("mountains")}>
					<i className="fa-solid fa-mountain-sun"></i>
					<span>Mountains</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("trending")}>
					<i className="fa-solid fa-fire"></i>
					<span>Trending</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("mansions")}>
					<i className="fa-solid fa-landmark"></i>
					<span>Mansions</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("majestic")}>
					<i className="fa-solid fa-crown"></i>
					<span>Majestic</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("arctic")}>
					<i className="fa-regular fa-snowflake"></i>
					<span>Arctic</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("woods")}>
					<i className="fa-solid fa-tree"></i>
					<span>Woods</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("govtsecret")}>
					<i className="fa-solid fa-circle-radiation"></i>
					<span>Govt secret</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("private")}>
					<i className="fa-regular fa-eye-slash"></i>
					<span>Private escapes</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("theater")}>
					<i className="fa-solid fa-film"></i>
					<span>Home theater</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("studios")}>
					<i className="fa-solid fa-palette"></i>
					<span>Studios</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("gaming")}>
					<i className="fa-solid fa-gamepad"></i>
					<span>Gaming dens</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("fitness")}>
					<i className="fa-solid fa-dumbbell"></i>
					<span>Fitness</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("creme")}>
					<i className="fa-regular fa-gem"></i>
					<span>Crème de la crème</span>
				</div>
				{/* <div className="category-selector" onClick={e => setFilter("green")}>
					<i className="fa-solid fa-leaf"></i>
					<span>Green</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("rustic")}>
					<i className="fa-solid fa-stroopwafel"></i>
					<span>Rustic</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("urban")}>
					<i className="fa-solid fa-hashtag"></i>
					<span>Urban</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("tornado")}>
					<i className="fa-solid fa-tornado"></i>
					<span>Tornado</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("camps")}>
					<i className="fa-solid fa-tent"></i>
					<span>Camps</span>
				</div>
				<div className="category-selector" onClick={e => setFilter("420")}>
